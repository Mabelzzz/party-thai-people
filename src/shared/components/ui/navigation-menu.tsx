...
function NavigationMenuList({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.List>) {
   return (
      <NavigationMenuPrimitive.List data-slot="navigation-menu-list" className={cn('group', className)} {...props} />
   )
}
...
const navigationMenuTriggerStyle = cva('group inline-flex items-center justify-center')
